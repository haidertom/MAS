	...
	def __init__(self, server_messages):
		...
		try:
			...
			while line:
				...
				self.initial_state.walls.append([])
				self.initial_state.boxes.append([])
				self.initial_state.goals.append([])

				for col, char in enumerate(line):

					self.initial_state.walls[row].append(False)
					self.initial_state.boxes[row].append(None)
					self.initial_state.goals[row].append(None)
					...
					if char == '+':
						...
						self.initial_state.goalsxy[char.upper()]=(row, col)
