...
class State:
	...
	MAX_ROW = 0 # initialized with 0, updated when searchclient reads map
	MAX_COL = 0 # initialized with 0, updated when searchclient reads map
	...
	def __init__(self, copy: 'State' = None):
		...
		if copy is None:
			...
			self.goalsxy = {} # will store coordinate tuples in dictionary of goals
